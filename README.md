...
# 📖 [Math-Magicians PRJECT] <a name="about-project"></a>

**[Abiy Capstone One]** This is a Math-Magicians project created during my Microverse course. 
...
```
  git clone https://github.com/abiy006/Math-Magicians.git
```
### Install
